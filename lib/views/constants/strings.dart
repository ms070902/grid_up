...
class Strings {
  ...
  static const noPostsAvailable =
      "Nobody seems to have made any posts yet. Why don't you take the first "
      "step and upload your first post?";
  static const enterYourSearchTerm =
      'Enter your search term in order to get started. You can search in the '
      'description of all the posts available in the system';
  ...
  static const noCommentsYet =
      'Nobody has commented on this post yet. You can change that though, '
      'and be the first person to comment!';
