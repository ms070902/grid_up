...
import 'package:nexus/state/image_upload/constants/constants.dart';
import 'package:nexus/state/image_upload/exceptions/could_not_build_thumbnail_exception.dart';
import 'package:nexus/state/image_upload/extensions/get_collection_name_from_file_type.dart';
import 'package:nexus/state/image_upload/extensions/get_image_data_aspect_ratio.dart';
import 'package:nexus/state/image_upload/typedef/is_loading.dart';
import 'package:nexus/state/posts/models/post_payload.dart';
...
class ImageUploadNotifier extends StateNotifier<IsLoading> {
  ...
  Future<bool> upload({
    ...
    ///calculate references (generate file name from uuid)
    ...
    try {
      ...
      final postPayload = PostPayload(
        ...
        originalStorageId: originalFileStorageId,
